function [output] = BIOMD0000000051_url_odefun(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chassagnole2002_Carbon_Metabolism
% Generated: 16-Jul-2022 21:29:05
% 
% [output] = BIOMD0000000051_url_odefun() => output = initial conditions in column vector
% [output] = BIOMD0000000051_url_odefun('states') => output = state names in cell-array
% [output] = BIOMD0000000051_url_odefun('algebraic') => output = algebraic variable names in cell-array
% [output] = BIOMD0000000051_url_odefun('parameters') => output = parameter names in cell-array
% [output] = BIOMD0000000051_url_odefun('parametervalues') => output = parameter values in column vector
% [output] = BIOMD0000000051_url_odefun('variablenames') => output = variable names in cell-array
% [output] = BIOMD0000000051_url_odefun('variableformulas') => output = variable formulas in cell-array
% [output] = BIOMD0000000051_url_odefun(time,statevector) => output = time derivatives in column vector
% 
