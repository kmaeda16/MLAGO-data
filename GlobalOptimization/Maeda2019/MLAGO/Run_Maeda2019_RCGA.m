function Run_Maeda2019_RCGA(seed)
% clearvars;
...
ModelDir = '../Maeda2019_Simulation_20220716_1';
UtilDir = '../util';
...
%% RCGA
% ========= Problem Settings ========= %
problem.n_gene = 18; % Number of Decision Variables
problem.n_constraint = 1; % Number of Constraints
problem.fitnessfun = @Fitness_Maeda2019; % Fitness Function
...
opts.maxeval = 2e+5; % Max Number of fitnessfun Evaluations
